...
test
The `test-pacman.R` doesn't follow the testthat rule, which is just a source file with different pacman syntax to test the code. Proper test code can be added later if needed.
```{r}
